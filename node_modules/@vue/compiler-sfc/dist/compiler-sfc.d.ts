...
import {
    ...
    SourceLocation,
    ElementNode,
    BindingMetadata as BindingMetadata$1
...
export {
    shouldTransform as shouldTransformRef, transform as transformRef, transformAST as transformRefAST
...
export type SimpleTypeResolveContext =
    Pick<ScriptCompileContext, 'source' | 'filename' | 'error' | 'options'>
