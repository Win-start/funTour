...
var CouponList = withInstall(stdin_default58);
...
var timePickerPropKeys = Object.keys(stdin_default59.props);
var datePickerPropKeys = Object.keys(stdin_default60.props);
var datetimePickerProps = extend({}, stdin_default59.props, stdin_default60.props, {
...
var stdin_default61 = defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      const Component = isTimePicker ? stdin_default59 : stdin_default60;
...
var DatetimePicker = withInstall(stdin_default61);
...
var stdin_default62 = defineComponent({
  ...
  setup(props, {
    ...
    const renderMessage = (hasTitle) => {
      ...
      const classNames = bem54("message", {
        "has-title": hasTitle,
...
function initInstance() {
  const Wrapper = {
    setup() {
      ...
      return () => createVNode(stdin_default62, mergeProps(state, {
        "onUpdate:show": toggle
      }), null);
    }
  };
...
Dialog.Component = withInstall(stdin_default62);
Dialog.install = (app) => {
...
var Divider = withInstall(stdin_default63);
...
var DropdownItem = withInstall(stdin_default65);

// node_modules/vant/es/dropdown-menu/index.js
var DropdownMenu = withInstall(stdin_default64);
...
var Empty = withInstall(stdin_default66);
