...
// node_modules/chinese-to-pinyin/dist/index.js
var require_dist = __commonJS({
  "node_modules/chinese-to-pinyin/dist/index.js"(exports, module) {
    module.exports = function(n) {
      var g = {};
      function h(i) {
        if (g[i])
          return g[i].exports;
        var u = g[i] = { i, l: false, exports: {} };
        return n[i].call(u.exports, u, u.exports, h), u.l = true, u.exports;
      }
      return h.m = n, h.c = g, h.d = function(n2, g2, i) {
        h.o(n2, g2) || Object.defineProperty(n2, g2, { enumerable: true, get: i });
      }, h.r = function(n2) {
        ...
        if (1 & g2 && (n2 = h(n2)), 8 & g2)
          return n2;
        if (4 & g2 && "object" == typeof n2 && n2 && n2.__esModule)
          return n2;
        var i = /* @__PURE__ */ Object.create(null);
        if (h.r(i), Object.defineProperty(i, "default", { enumerable: true, value: n2 }), 2 & g2 && "string" != typeof n2)
          for (var u in n2)
            h.d(i, u, (function(g3) {
              return n2[g3];
            }).bind(null, u));
      ...
      g.default = (n2, g2 = {}) => {
        ...
        h2 = h2.join("");
        for (const n3 of y)
          if (~h2.indexOf(n3) && (h2 = h2.replace(new RegExp(n3, "g"), ` ${g2.firstCharacter ? i[n3].split(" ").map((n4) => n4.substring(0, 1)).join(" ") : i[n3]}`), z.lastIndex = 0, !z.test(h2)))
            break;
        return h2 = h2.trim(), g2.toneToNumber || g2.toneToNumberOnly ? h2 = ((n3, g3) => {
          const h3 = n3.split(" ");
          return h3.forEach((n4, i2) => {
            let z2 = 0;
            Object.keys(u).forEach((g4) => {
              ~n4.indexOf(g4) && (z2 = g4, h3[i2] = n4.replace(new RegExp(g4, "g"), u[g4][0]));
            });
            const y2 = z2 && u[z2][1];
            g3 ? h3[i2] = y2 : h3[i2] += y2;
          }), h3.join(" ");
        })(h2, g2.toneToNumberOnly) : g2.removeTone && (h2 = ((n3) => (Object.keys(u).forEach((g3) => {
          ~n3.indexOf(g3) && (n3 = n3.replace(new RegExp(g3, "g"), u[g3][0]));
        }), n3))(h2)), g2.keepRest && g2.removeSpace ? (h2 = h2.split(" "), h2 = n2.replace(z, () => h2.shift())) : g2.keepRest && !g2.removeSpace ? (h2 = h2.split(" "), h2 = n2.replace(z, (g3, i2) => (z.lastIndex = 0, `${z.test(n2[i2 - 1]) ? " " : ""}${h2.shift()}`))) : !g2.keepRest && g2.removeSpace && (h2 = h2.replace(new RegExp(" ", "g"), "")), h2;
      };
    }]);
  }
});

// node_modules/chinese-to-pinyin/index.js
var require_chinese_to_pinyin = __commonJS({
  "node_modules/chinese-to-pinyin/index.js"(exports, module) {
    module.exports = require_dist().default;
  }
});
export default require_chinese_to_pinyin();
//# sourceMappingURL=chinese-to-pinyin.js.map
